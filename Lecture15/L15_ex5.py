...
def kmer_count():
    ...
    # ask the user for the sequence that they want to use for the analysis,
    #   what they want the length of the kmers to be, and what they want n
    #   to be, and stores all three of those inputs in seperate variables
    dna = input('What is the sequence you wish to run this k-mer analysis on? ')
    k = int(input('What length do you want the k-mers to be? '))
    n = int(input('What do you want the count threshold to be? '))
    
    # formats the inputted sequence correctly
    dna = dna.replace('\n', '').upper()
    ...
    #   that occurs in the given sequence more than n times, and returns the
    #   generated kmers
